...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>/principal.php" class="brand-link">
        <img src="<?php echo $URL;?>/public/imagenes/EGJMParking.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <span class="brand-text font-weight-light">EGJM Parking</span>
    </a>

    <!-- Sidebar -->
    <div class="sidebar">
        <!-- Sidebar user panel (optional) -->
        <div class="user-panel mt-n3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo $URL;?>/public/imagenes/icono_usuario2.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
